  ...
  return (
    <div className="w-full bg-starfield bg-cover bg-center relative">
      ...
      <div className="container mx-auto sm p-32">
        ...
        <div className="p-20 rounded-[64px] backdrop-blur-sm bg-gradient-to-l from-[#FFFFFF0B] border-solid border-[3px] border-[#c8d0cf] mb-64">
          <h3 className="font-monocraft-regular text-[#e9ebee] text-4xl mb-6">
            A 2D Space Game
          </h3>
        ...
        <div className="relative">
          ...
          <div className="p-20 rounded-[64px] backdrop-blur-sm bg-gradient-to-l from-[#FFFFFF0B] border-solid border-[3px] border-[#e9ebee] mb-64">
            <h3 className="font-monocraft-regular text-[#e9ebee] text-4xl mb-6">
              Move your ship
            </h3>
            <p className="font-dmsans-regular text-[#F1E9D9] text-xl leading-relaxed">
        ...
        <div className="relative">
          ...
          <div className="p-20 rounded-[64px] backdrop-blur-sm bg-gradient-to-l from-[#FFFFFF0B] border-solid border-[3px] border-[#c8d0cf]">
            <h3 className="font-monocraft-regular text-[#e9ebee] text-4xl mb-6">
              Gather fuel
            </h3>
            <p className="font-dmsans-regular text-[#F1E9D9] text-xl leading-relaxed">
      ...
      <div className="container mx-auto sm flex flex-col pt-16 pb-32 px-32">
        <h3 className="flex flex-row items-center justify-center mb-20">
          ...
          <span className="font-monocraft-regular text-[#e9ebee] text-4xl">Available Challenges</span>
        </h3>
              ...
              <div className="p-8">
                ...
                <div className="mb-4 flex flex-row items-center justify-between">
                  <button
                    ...
                    className="font-monocraft-regular text-[#e9ebee] border border-[#e9ebee] bg-transparent py-4 px-6 rounded-full text-lg flex-initial disabled:opacity-50"
                  >
                    Select
                  </button>
                </div>
