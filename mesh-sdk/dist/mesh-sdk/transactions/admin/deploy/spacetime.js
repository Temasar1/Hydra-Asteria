import { admin_token, fuel_per_step, initial_fuel, max_speed, min_asteria_distance } from "../../../const.js";
import { blockchainProvider, myWallet } from "../../../utils.js";
import { MeshTxBuilder, scriptHash } from "@meshsdk/core";
...
const deployScript = deployScriptAppliedParam(admin_token);
const deployScriptAddressBech32 = resolvePlutusScriptAddress(deployScript.deployPlutusScript, 0);
const spacetimeScript = spacetimeScriptAppliedParam(scriptHash(pelletScriptHash), scriptHash(asteriaScriptHash), admin_token, max_speed, fuel_per_step, initial_fuel, min_asteria_distance);
const spacetimeAsset = [
    {
        unit: "lovelace",
        quantity: "25088510"
    }
...
async function deploySpacetime() {
    ...
    await writeFile("./scriptref-hash/spacetime-script.json", JSON.stringify({ txHash: deploySpacetimeTx }));
}
;
