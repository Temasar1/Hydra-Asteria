import { admin_token, max_asteria_mining, ship_mint_lovelace_fee } from "../../../const.js";
...
const asteria = asteriaScriptAppliedParam(admin_token, ship_mint_lovelace_fee, max_asteria_mining);
...
async function deployAsteria() {
    ...
    await writeFile("./scriptref-hash/asteria-script.json", JSON.stringify({ txHash: deployAsteriaTx }));
}
;
