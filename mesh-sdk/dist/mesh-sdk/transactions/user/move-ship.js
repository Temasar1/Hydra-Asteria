import { byteString, conStr0, conStr1, deserializeDatum, integer, MeshTxBuilder, serializePlutusScript, stringToHex } from "@meshsdk/core";
...
async function moveShip(fuel_per_step, delta_X, delta_Y, tx_earliest_posix_time, tx_latest_posix_time, ship_tx_hash) {
    ...
    ;
    const shipInputAda = ship.output.amount.find((Asset) => Asset.unit === "lovalace");
