import { byteString, conStr0, deserializeDatum, integer, MeshTxBuilder, policyId, serializePlutusScript, stringToHex, } from "@meshsdk/core";
...
async function createShip(ship_mint_lovelace_fee, initial_fuel, posX, posY, tx_latest_posix_time) {
    ...
    const asteriaInputAda = asteriaInputUtxos[0].output.amount.find((Asset) => Asset.unit === "lovelace");
