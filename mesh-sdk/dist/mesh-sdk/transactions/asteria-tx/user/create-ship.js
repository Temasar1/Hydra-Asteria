import { assetName, conStr0, deserializeDatum, integer, MeshTxBuilder, policyId, posixTime, serializePlutusScript, stringToHex, } from "@meshsdk/core";
import { blockchainProvider, myWallet, tx_latest_slot } from "../../utils.js";
...
async function createShip(posX, posY) {
    ...
    const asteriaPlutusScript = asteriaScriptRef;
    ...
    const asteriaInputAda = asteria.output.amount.find((Asset) => Asset.unit === "lovelace");
