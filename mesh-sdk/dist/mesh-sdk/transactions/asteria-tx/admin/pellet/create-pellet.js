import { conStr0, integer, MeshTxBuilder, scriptHash, stringToHex } from "@meshsdk/core";
...
export async function createPellet(pelletProperty) {
    ...
    for (const pellet of pelletProperty) {
        ...
        txBuilder
            .mintPlutusScriptV3()
            .mint(pellet.fuel, fuelPolicyID, fueltokenNameHex)
