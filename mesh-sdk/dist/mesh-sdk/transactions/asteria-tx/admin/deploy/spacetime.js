...
const spacetimeScript = applyParamtoSpacetime(scriptHash(pelletScriptHash), scriptHash(asteriaScriptHash), admin_token, max_speed, max_ship_fuel, fuel_per_step);
...
async function deploySpacetime() {
    ...
    await writeFile("./scriptref-hash/spacetime-script.json", JSON.stringify({ txHash: txHash }));
}
;
